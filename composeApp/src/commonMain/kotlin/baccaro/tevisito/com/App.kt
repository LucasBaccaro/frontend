...
import baccaro.tevisito.presentation.auth.LoginScreen
import baccaro.tevisito.presentation.auth.RegisterScreen
...
fun App() {
    MaterialTheme {
        ...
        NavHost(navController = navController, startDestination = "login", modifier = Modifier.systemBarsPadding(),) {
            composable(
...
fun HomeScreen() {
    Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        Text("¡Bienvenido! Login/Registro exitoso.", style = MaterialTheme.typography.headlineMedium)
    }
}